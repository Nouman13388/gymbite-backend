...
try {
  ...
  execSync('npx prisma migrate resolve --rolled-back 20251010184529_update_meal_plan_structure', { 
    stdio: 'inherit',
    env: { ...process.env }
  });
  ...
  try {
    ...
    console.log('ℹ️  Data fix may have failed (this is expected if columns don\'t exist yet)');
  }
